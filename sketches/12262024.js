let maze, maze2, maze3, maze4;
const mazes = [];
const maxDepth = 30;

function setup() {
  createCanvas(windowWidth, windowHeight);
  maze = new createMaze(15, color(0), 2);
  maze2 = new createMaze(10, color(50), 1);
  maze3 = new createMaze(5, color(100), 0.5);
  maze4 = new createMaze(2, color(150), 0.25);
...
function draw() {
  radialGradient(color(255), color(100));
  // maze4.drawMaze();
  // maze3.drawMaze();
  // maze2.drawMaze();
  maze.drawMaze();
